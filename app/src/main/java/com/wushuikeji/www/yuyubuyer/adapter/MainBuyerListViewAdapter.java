...
//        viewHold.shopDistance.setText(String.valueOf(disance));
        ...
        if("5".equals(grades)) {
            viewHold.buyerGrade.setBackgroundResource(R.mipmap.v5);
        }else if("4".equals(grades)) {
            viewHold.buyerGrade.setBackgroundResource(R.mipmap.v4);
        }else if("3".equals(grades)) {
            viewHold.buyerGrade.setBackgroundResource(R.mipmap.v3);
        }else if("2".equals(grades)) {
            viewHold.buyerGrade.setBackgroundResource(R.mipmap.v2);
        }else {
            viewHold.buyerGrade.setBackgroundResource(R.mipmap.v1);
        }
        //设置图片
