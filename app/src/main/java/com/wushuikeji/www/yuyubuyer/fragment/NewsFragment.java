...
import com.wushuikeji.www.yuyubuyer.activity.DynamicEvaluateActivity;
...
//        mNewsFragmentView = View.inflate(UIUtils.getContext(), R.layout.main_news, null);
    ...
    public void initEvent() {
        ...
        rl_news_comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToNextActivityUtils.toNextAndNoFinishActivity(getActivity(), DynamicEvaluateActivity.class);
            }
        });
        //系统消息
