...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private void initEvent() {
        ...
        tv_userinfo_dynamic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ToNextActivityUtils.toNextAndNoFinishActivity(UserInfoActivity.this, DynamicEvaluateActivity.class);
            }
        });
        //点击举报
        tv_userInfo_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mIsLoginBoolean) {
                    //登录过
                    ToNextActivityUtils.toNextActivityNotFinishAndParameters(UserInfoActivity.this, ReportInputTextActivity.class, "BuyerId", mBuyerId);
                } else {
                    //提示
                    ToastUtils.showToastInUIThread(UIUtils.getContext(), MyConstants.LOGIN);
                    ToNextActivityUtils.toNextAndNoFinishActivity(UserInfoActivity.this, LoginActivity.class);
                }
            }
        });
        //点击关注
        ...
        rl_userInfo_video.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mIsLoginBoolean) {
                    //登录过
                    //ToNextActivityUtils.toNextAndNoFinishActivity(UserInfoActivity.this, ReportInputTextActivity.class);
                } else {
                    //提示
                    ToastUtils.showToastInUIThread(UIUtils.getContext(), MyConstants.LOGIN);
                    ToNextActivityUtils.toNextAndNoFinishActivity(UserInfoActivity.this, LoginActivity.class);
        ...
        ll_commomInfo_attentionLinearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToNextActivityUtils.toNextActivityNotFinishAndTwoParameters(UserInfoActivity.this,CommonAttentionFansFriendActivity.class,"buyerId",mBuyerId,"index","2");
            }
        });
        ...
        ll_commomInfo_fansLinearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToNextActivityUtils.toNextActivityNotFinishAndTwoParameters(UserInfoActivity.this,CommonAttentionFansFriendActivity.class,"buyerId",mBuyerId,"index","3");
            }
        });
        ...
        ll_commomInfo_friendLinearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToNextActivityUtils.toNextActivityNotFinishAndTwoParameters(UserInfoActivity.this,CommonAttentionFansFriendActivity.class,"buyerId",mBuyerId,"index","1");
            }
        });
    }
    ...
    private void choiceWhichBuyerServer(int videoIndex, int shoppingIndex) {
        ...
        if (shoppingIndex == 1) {
            //点亮线下（红色图片暂时没有）
            //iv_userInfo_shopping.setBackgroundResource(R.mipmap.shop_pre);
    ...
    private void choiceBuyerGrade(int grades) {
        switch (grades) {
            case 1:
                iv_userInfo_grade.setBackgroundResource(R.mipmap.v1);
                break;
            case 2:
                iv_userInfo_grade.setBackgroundResource(R.mipmap.v2);
                break;
            case 3:
                iv_userInfo_grade.setBackgroundResource(R.mipmap.v3);
                break;
            case 4:
                iv_userInfo_grade.setBackgroundResource(R.mipmap.v4);
                break;
            case 5:
                iv_userInfo_grade.setBackgroundResource(R.mipmap.v5);
                break;
            default:
                break;
        }
