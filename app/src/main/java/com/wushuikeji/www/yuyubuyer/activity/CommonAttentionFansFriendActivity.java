    ...
    private void initEvent() {
        ...
        commonFriend_listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ToNextActivityUtils.toNextActivityNotFinishAndParameters(CommonAttentionFansFriendActivity.this, UserInfoActivity.class, "BuyerId", buyerBeanList.get(position).userId);
            }
        });
